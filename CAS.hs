module CAS (modify_equations_randomly) where
...
expression_function_definitions (Function "-" [expression1, expression2])
  | (expression1 == expression2) = Integer 0
  | otherwise = Function "-" [expression1, expression2]
expression_function_definitions expression = expression
...
expression_commutive (Function function1 [expression1, expression2])
  | (elem function1 commutative_functions) = Function function1 [expression2, expression1]
  | otherwise = Function function1 [expression1, expression2]
  where
...
expression_associative (Function function1 [expression1, expression2])
  | (Function function2 [expression3, expression4], expression5) <- (expression1, expression2),
    function1 == function2,
    function1 `elem` associative_functions =
      Function function1 [expression3, Function function2 [expression4, expression5]]
  | (expression3, Function function2 [expression4, expression5]) <- (expression1, expression2),
    function1 == function2,
    function1 `elem` associative_functions =
      Function function1 [Function function2 [expression3, expression4], expression5]
  where
...
get_subexpression n (x : xs) =
  let num_nodes = expression_num_nodes x
...
equations_substitution (Equal expression1 expression2) (Equal expression3 expression4) =
  let substitute_expression input_expression =
        if (input_expression == expression1)
          then expression2
          else input_expression
   in Equal (helper_expression_substitution substitute_expression expression3) (helper_expression_substitution substitute_expression expression4)
...
helper_expression_substitution substitute expression
  | (expression /= substitute expression) = substitute expression
  | (Function function1 expression_list) <- expression = Function function1 (map (helper_expression_substitution substitute) expression_list)
